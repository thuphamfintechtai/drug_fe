  ...
  return (
    ...
    >
      ...
      <svg className="w-16 h-8 -ml-2" viewBox="0 0 220 110">
        ...
        {/* Walking person */}
        <motion.g
          animate={{ x: animating ? [0, 90] : 0, opacity: animating ? [1, 0.9, 0.5] : 1 }}
        ...
        <g transform="translate(150,20) scale(0.9)">
          {/* Khung cửa ngoài */}
          <rect x="0" y="0" width="52" height="70" rx="8" fill="#fee2e2" stroke="#fca5a5" strokeWidth="1.5" />
          ...
          >
            ...
            <rect x="5" y="5" width="42" height="60" rx="4" fill="url(#doorGradRed)" />
