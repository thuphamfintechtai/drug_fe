import { useManufactorDrugDetailModal } from "../hooks/useManufactorDrugDetailModal";
import React from "react";
import { formatDate } from "../../utils/helper";
const ManufactorDrugDetailModal = ({ isOpen, onClose, drugId }) => {
  const { drug, loading, error, loadDrugDetails } =
    useManufactorDrugDetailModal({ isOpen, onClose, drugId });
  if (!isOpen) {
    return null;
  }
