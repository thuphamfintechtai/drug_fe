...
export default function UserNFTTracking() {
  ...
  const navigationItems = [
    ...
    { path: '/user/nft-tracking', label: 'Tra cứu NFT', active: true },
    ...
    <DashboardLayout navigationItems={navigationItems}>
      ...
      >
        ...
        <div className="relative px-6 py-8 md:px-10 md:py-12 text-white">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight drop-shadow-sm">🔍 Tra cứu hành trình thuốc</h1>
          <p className="text-white/90 mt-2">Nhập NFT ID để xem toàn bộ hành trình từ sản xuất đến phân phối</p>
        </div>
      </motion.section>
      ...
      {loading ? (
        ...
        <motion.div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl border border-blue-200 p-10 text-center" variants={fadeUp} initial="hidden" animate="show">
          ...
          <p className="text-slate-600 max-w-md mx-auto">Nhập NFT Token ID vào ô tìm kiếm phía trên để xem hành trình thuốc từ nhà sản xuất đến nhà thuốc</p>
        </motion.div>
      ) : !journey ? (
