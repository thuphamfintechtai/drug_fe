      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border-2 border-[#7AC3DE] shadow-[0_4px_12px_rgba(122,195,222,0.12)] overflow-hidden">
            {/* Header */}
            <div 
              className="bg-gradient-to-r from-[#4BADD1] to-[#7AC3DE] px-8 py-6 border-b-2 border-[#7AC3DE] cursor-pointer hover:opacity-90 transition-opacity"
            ...
            <div className="bg-white rounded-2xl border-2 border-[#7AC3DE] shadow-[0_4px_12px_rgba(122,195,222,0.12)] overflow-hidden">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <motion.div
                    animate={{ rotate: expandedSection.pharmacy ? 180 : 0 }}
                    transition={{ duration: 0.3 }}
                    className="text-white"
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
