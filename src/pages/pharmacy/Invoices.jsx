    ...
    <DashboardLayout navigationItems={navigationItems} metrics={metrics}>
      ...
      <section className="relative overflow-hidden rounded-2xl border border-[#90e0ef33] shadow-[0_10px_30px_rgba(0,0,0,0.06)] bg-gradient-to-tr from-[#00b4d8] via-[#48cae4] to-[#90e0ef]">
        ...
        <div className="relative px-6 py-8 md:px-10 md:py-12 text-white">
          <h1 className="text-2xl md:text-3xl font-semibold tracking-tight drop-shadow-sm">DrugTrace — Hóa đơn • Minh bạch và tin cậy</h1>
          <p className="mt-2 text-white/90">Tra cứu nhanh, dữ liệu xác thực bởi Blockchain.</p>
        </div>
      </section>
        ...
        {loading ? (
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              ...
              {items.length === 0 && (
                <tr><td className="p-4 text-slate-600" colSpan={6}>Không có dữ liệu</td></tr>
              )}
            </tbody>
          </table>
        )}
