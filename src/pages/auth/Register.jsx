      ...
      >
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-[#4BADD1] mb-2">Đăng ký tài khoản</h1>
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-gray-600">
              Đã có tài khoản?{' '}
              <Link to="/login" className="text-[#4BADD1] font-semibold hover:underline">
                Đăng nhập ngay
              </Link>
            </p>
            <p className="text-sm text-gray-600">
              Đăng ký doanh nghiệp?{' '}
              <Link to="/register-business" className="text-[#4BADD1] font-semibold hover:underline">
                Đăng ký doanh nghiệp
              </Link>
            </p>
          </div>
