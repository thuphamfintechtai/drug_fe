      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Tìm kiếm Manufacturer</h1>
              <p className="text-sm text-gray-500">Tra cứu thông tin nhà sản xuất</p>
            </div>
          </div>
          ...
          {hasSearched && !loading && (
            <div className="mt-4 p-4 bg-cyan-50 border border-cyan-200 rounded-xl">
              <p className="text-gray-800 font-semibold">
                ...
                {keyword && <span className="text-gray-600 ml-2">với từ khóa: "{keyword}"</span>}
              </p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="p-12 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Bắt đầu tìm kiếm</h3>
              <p className="text-gray-600">Nhập tên nhà sản xuất để tìm kiếm</p>
            </div>
          ) : results.length === 0 ? (
            /* Empty State */
            <div className="p-12 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Không tìm thấy</h3>
              <p className="text-gray-600">Không có nhà sản xuất nào với từ khóa "{keyword}"</p>
            </div>
          ) : (
            /* Table with Results */
                ...
                <tbody className="divide-y divide-gray-100">
                  {results.map((m, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-gray-700">{m.contactEmail}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
