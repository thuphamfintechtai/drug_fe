      ...
      <section className="py-10 bg-white">
        <div className="w-full">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7, ease: "easeOut" }}
            className="relative rounded-3xl overflow-hidden shadow-2xl mx-4 md:mx-8 lg:mx-16"
            style={{
          ...
          >
            <div className="relative z-10 px-8 py-16 md:px-16 md:py-20 text-center">
              ...
              <motion.p 
                className="text-lg md:text-xl mb-12 text-white/95 max-w-2xl mx-auto leading-relaxed"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                ...
                >
                  <Link
                    to="/register"
                    className="block px-10 py-4 bg-white text-[#4BADD1] font-bold rounded-xl hover:shadow-2xl transition-all duration-300 shadow-xl hover:bg-slate-50"
                    style={{
                      boxShadow: '0 10px 30px rgba(75, 173, 209, 0.3)'
                    }}
                  >
                    Đăng ký người dùng
                  </Link>
                ...
                >
                  <Link
                    ...
                    className="block px-10 py-4 bg-white/10 backdrop-blur-md text-white font-bold rounded-xl border-2 border-white/40 hover:bg-white/20 transition-all duration-300 shadow-xl"
                    style={{
