...
import {
  useDistributorGetDistributionStats,
  useDistributorGetInvoiceStats,
...
export default function Stats() {
  ...
  const { mutateAsync: fetchDistributionStats } =
    useDistributorGetDistributionStats();
  const { mutateAsync: fetchInvoiceStats } = useDistributorGetInvoiceStats();
              ...
              <Card className="rounded-2xl shadow-lg border border-gray-100">
                ...
                <div className="text-3xl font-bold text-blue-600">
                  {invoiceStats.totalRevenue
                    ? `${Number(invoiceStats.totalRevenue).toLocaleString(
                        "vi-VN"
                      )} ₫`
                    : "0 ₫"}
                </div>
