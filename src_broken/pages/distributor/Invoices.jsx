...
import { useDistributorGetMyInvoices } from "../../hooks/react-query/distributor/use.distributor";
...
export default function Invoices() {
  ...
  const { mutateAsync: fetchMyInvoices } = useDistributorGetMyInvoices();
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "pharmacyName",
      render: (text, record) =>
        text || record.toPharmacy?.name || record.toPharmacy?.username || "N/A",
    },
    {
      title: "Thuốc",
      dataIndex: "drugName",
