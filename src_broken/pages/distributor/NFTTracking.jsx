...
import { useDistributorTrackDrugByNFTId } from "../../hooks/react-query/distributor/use.distributor";
...
export default function NFTTracking() {
  ...
  const { mutateAsync: trackDrugByNFT } = useDistributorTrackDrugByNFTId();
