            ...
            <div className="bg-gradient-to-br from-[#4BADD1]/10 to-[#3aaad8]/10 rounded-2xl border border-[#4BADD1]/30 p-6">
              ...
              journey.journey.length > 0 ? (
                <div className="relative">
                  ...
                  <motion.div
                    className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#4BADD1] via-[#3aaad8] to-[#2f9ac4]"
                    initial={{ scaleY: 0 }}
                    animate={{ scaleY: 1 }}
                  ...
                  {journey.journey.map((step, idx) => (
                    ...
                    >
                      ...
                      >
                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#4BADD1] via-[#3aaad8] to-[#2f9ac4] border-4 border-white shadow-lg flex items-center justify-center">
                          <motion.span
                      ...
                      >
                        <div className="rounded-xl border border-[#4BADD1]/30 bg-white p-5 shadow-sm hover:shadow-md transition">
                          ...
                          <div className="space-y-2 text-sm text-primary">
                            ...
                            {step.to && (
                              <div className="flex items-center gap-2">
                                <span className="text-primary">Đến:</span>
